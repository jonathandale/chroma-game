...
var G__25236 = o;
(G__25236[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__25238__i < G__25238__a.length) {G__25238__a[G__25238__i] = arguments[G__25238__i + 0]; ++G__25238__i;}
  args = new cljs.core.IndexedSeq(G__25238__a,0);
} 
...
var old_25240 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_25240))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_25240)].join(''):class$));
} else {
}
...
var G__25243 = jsprops;
(G__25243["defaultValue"] = value);

(G__25243["onChange"] = ((function (G__25243,v,value,on_change){
return (function (p1__25241_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25241_SHARP_);
});})(G__25243,v,value,on_change))
);
...
var vec__25245 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25245,(0),null);
var id = cljs.core.nth.call(null,vec__25245,(1),null);
var class$ = cljs.core.nth.call(null,vec__25245,(2),null);
...
var temp__4128__auto__ = (function (){var G__25247 = cljs.core.meta.call(null,v);
var G__25247__$1 = (((G__25247 == null))?null:reagent.impl.template.get_key.call(null,G__25247));
return G__25247__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__25249_25250 = v;
var G__25249_25251__$1 = (((G__25249_25250 == null))?null:reagent.impl.template.key_from_vec.call(null,G__25249_25250));
var G__25249_25252__$2 = (((G__25249_25251__$1 == null))?null:(jsprops["key"] = G__25249_25251__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__25255 = cljs.core.meta.call(null,argv);
var G__25255__$1 = (((G__25255 == null))?null:reagent.impl.template.get_key.call(null,G__25255));
return G__25255__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__25256 = (((jsprops == null))?{}:jsprops);
(G__25256["key"] = key);
...
var n__19006__auto___25257 = a.length;
var i_25258 = (0);
while(true){
if((i_25258 < n__19006__auto___25257)){
(a[i_25258] = reagent.impl.template.as_element.call(null,(a[i_25258])));

var G__25259 = (i_25258 + (1));
i_25258 = G__25259;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19006__auto___25260 = a.length;
var i_25261 = (0);
while(true){
if((i_25261 < n__19006__auto___25260)){
var val_25262 = (a[i_25261]);
if((cljs.core.vector_QMARK_.call(null,val_25262)) && ((reagent.impl.template.key_from_vec.call(null,val_25262) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25261] = reagent.impl.template.as_element.call(null,val_25262));

var G__25263 = (i_25261 + (1));
i_25261 = G__25263;
continue;
} else {
}
...
var G__25265 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25265) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25265){
...
//# sourceMappingURL=template.js.map?rel=1439894834357