...
if(!((function (){var G__25445 = app_db;
if(G__25445){
...
return G__25445.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__25445.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__25445);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__25451){
var args = cljs.core.seq(arglist__25451);
...
return cljs.core.get_in.call(null,new_db,p1__25452_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__25453_SHARP_){
return cljs.core.get_in.call(null,db,p1__25453_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__25454__i = 0, G__25454__a = new Array(arguments.length -  2);
while (G__25454__i < G__25454__a.length) {G__25454__a[G__25454__i] = arguments[G__25454__i + 2]; ++G__25454__i;}
  in_paths = new cljs.core.IndexedSeq(G__25454__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__25455){
var f = cljs.core.first(arglist__25455);
arglist__25455 = cljs.core.next(arglist__25455);
var out_path = cljs.core.first(arglist__25455);
var in_paths = cljs.core.rest(arglist__25455);
...
//# sourceMappingURL=middleware.js.map?rel=1439894834782